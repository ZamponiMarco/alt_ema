...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('--user_trajectory', type=str, required=True, 
                       help='User trajectory e.g. 10,20,30,40,50')
...
def main() -> int:
    ...
    try:
        ...
        timestamps = runner.run([float(x) for x in args.user_trajectory.split(",")])
